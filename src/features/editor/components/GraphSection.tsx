...
const GraphSection = forwardRef<HTMLDivElement, GraphSectionProps>(
  function (_props, ref) {
    return (
      <div ref={ref} className="h-full relative py-4 px-4">
        <div className="h-full rounded-lg overflow-hidden bg-muted/50 p-4">
          <svg className="hidden" width={'100%'} height={'100%'}>
            <defs>
